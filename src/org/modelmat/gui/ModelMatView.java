...
import org.modelmat.gui.action.ShowAboutDialog;
import org.modelmat.gui.action.ShowNotYetImplementedMessage;
import org.modelmat.gui.action.ShowTipOfTheDay;
import org.modelmat.gui.chart.ChartView;
import org.modelmat.gui.report.ReportView;
import org.modelmat.gui.table.SpreadsheetView;
...
public class ModelMatView extends FrameView {
    ...
    private void initSpecificActions() {
        ...
        bPrint.setAction(new ShowNotYetImplementedMessage("Print",
                "/org/modelmat/gui/resources/Print16.gif",
                "/org/modelmat/gui/resources/Print24.gif"));
        bPrint.setText(null);
    ...
    private void initComponents() {
        ...
        miOpen.setAction(new ShowNotYetImplementedMessage("Open File",
                "/org/modelmat/gui/resources/Open16.gif", "/org/modelmat/gui/resources/Open24.gif"));
        mFile.add(miOpen);

        miImport.setAction(new ShowNotYetImplementedMessage("Import File",
                "/org/modelmat/gui/resources/Import16.gif",
                "/org/modelmat/gui/resources/Import24.gif"));
        mFile.add(miImport);

        miExport.setAction(new ShowNotYetImplementedMessage("Export File",
                "/org/modelmat/gui/resources/Export16.gif",
                "/org/modelmat/gui/resources/Export24.gif"));
        mFile.add(miExport);
        mFile.add(miSeparator1);

        miSave.setAction(new ShowNotYetImplementedMessage("Save",
                "/org/modelmat/gui/resources/Save16.gif", "/org/modelmat/gui/resources/Save24.gif"));
        mFile.add(miSave);
        mFile.add(miPrint);
        mFile.add(miSeparator2);

        miExit.setIcon(new javax.swing.ImageIcon(getClass().getResource(
                "/org/modelmat/gui/resources/Exit16.gif"))); // NOI18N
        ...
        bOpenFile
                .setAction(new ShowNotYetImplementedMessage("Open File",
                        "/org/modelmat/gui/resources/Open16.gif",
                        "/org/modelmat/gui/resources/Open24.gif"));
    ...
    private org.modelmat.gui.chart.ChartView chartView;
    ...
    private org.modelmat.gui.report.ReportView reportView;

    private org.modelmat.gui.table.SpreadsheetView spreadsheet;
