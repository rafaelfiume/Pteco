...
public class ShowAboutDialog extends AbstractAction {
    ...
    private static final String SMALL_ICON = 
                "/org/modelmat/gui/resources/About16.gif";
    
    private static final String LARGE_ICON_KEY = 
                "/org/modelmat/gui/resources/About24.gif";
    ...
    public ShowAboutDialog() {
        ...
        putValue(Action.SMALL_ICON, new ImageIcon(
                ShowAboutDialog.class.getResource(SMALL_ICON)));

        putValue(Action.LARGE_ICON_KEY, new ImageIcon(
                ShowAboutDialog.class.getResource(LARGE_ICON_KEY)));
    }
