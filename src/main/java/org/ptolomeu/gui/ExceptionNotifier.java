...
public class ExceptionNotifier {
    ...
    private static void notify(CoordinateNumberException coordinateNumberException) {
        JOptionPane.showMessageDialog(null, COORDINATE_NUMBER_EXCEPTION_MESSAGE,
                COORDINATE_NUMBER_EXCEPTION_TITLE, JOptionPane.INFORMATION_MESSAGE);
    }

    private static void notify(InsufficientDataException insufficientDataException) {
        JOptionPane.showMessageDialog(null, INSUFFICIENT_DATA_EXCEPTION_MESSAGE,
                INSUFFICIENT_DATA_EXCEPTION_TITLE, JOptionPane.INFORMATION_MESSAGE);
    }
