...
public class NonLinearRegression extends AbstractRegression {
    ...
    public NonLinearRegressionResult doRegression(final Map<XyIndex, Double> matriz)
        ...
        final NonLinearRegressionResult nonLinearResult = new NonLinearRegressionResult();
        ...
        nonLinearResult.coefA = (y1 - (a13 * nonLinearResult.coefC) - (a12 * nonLinearResult.coefB))
                / (float) a11;
